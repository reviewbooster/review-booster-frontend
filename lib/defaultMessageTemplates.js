 ...
 * Thank + Refer messages. These are only the DEFAULTS ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the moment an
...
var RESOLVED_FOLLOWUP_MIDDLE = 'we\'ve resolved the issue you mentioned earlier and hope things are looking better now. If you\'re happy with how it was handled, we\'d really appreciate an updated review \u2014 it means a lot to us.';
...
export function getDefaultTemplates(businessType) {
  ...
  return {
    ...
    resolved_followup: 'Hi {{name}}, ' + RESOLVED_FOLLOWUP_MIDDLE + '\n\n{{link}}',
  };
}
