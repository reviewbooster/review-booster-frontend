 ...
 * Private Feedback page -- session history in comments below.
 * Session 17 -- initial build.
 * Session 19 -- updates.
 * Session 19b -- updates.
 * Session 19c -- updates.
 * Later fix -- updates.
        ...
        <div className="p-5 overflow-y-auto">
          ...
          {!isStaff && status === 'Resolved' && (
            <>
              ...
              {resendLink && (
                <a href={resendLink.url} target="_blank" rel="noopener noreferrer"
