 ...
 * Reviews page -- session history in comments below.
 * Later fix -- updates.
        ...
        {!isStaff && (
          <div className="px-5 pb-5 space-y-2">
            ...
            {thankReferLink && thankReferLink.id === review._id && (
              <a href={thankReferLink.url} target="_blank" rel="noopener noreferrer"
            ...
            return (
              <div key={r._id}
                ...
                <div className="flex items-center gap-1.5 shrink-0 mt-0.5">
                  ...
                  {thankReferLink && thankReferLink.id === r._id && (
                    <a href={thankReferLink.url} target="_blank" rel="noopener noreferrer"
                      className="hidden md:flex items-center gap-1 px-2.5 py-1.5 text-[10px] font-semibold rounded-lg border border-green-200 text-green-600 bg-green-50 hover:bg-green-100 transition-colors">
                      Tap
                    </a>
                  )}
                  <button
