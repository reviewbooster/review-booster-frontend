...
function ReviewDetailModal({ review, idx, onClose }) {
    ...
    <div
      ...
      <div
        ...
        <div className="px-5 pb-5">
          <button
            disabled
            title="AI reply suggestions coming soon"
            className="w-full flex items-center justify-center gap-1.5 px-4 py-2.5 text-xs font-semibold rounded-xl border border-gray-200 text-gray-400 cursor-not-allowed">
...
function ReviewsPage() {
  ...
  useEffect(function() {
    api.get('/analytics/summary').then(function(res) {
  ...
  const load = useCallback(async function() {
    ...
    setError('');
    try {
      var params = new URLSearchParams({ page, limit: LIMIT });
  ...
  var handleExport = async function() {
    ...
    try {
      var res = await api.get('/reviews/export', { responseType: 'blob' });
  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        <button className="flex items-center gap-1.5 bg-white border border-gray-200 rounded-xl px-3 py-2 text-[11px] text-gray-500 font-medium">
        ...
        {(filter.rating || filter.channel) && (
          <button
            onClick={function() { setFilter({ rating: '', channel: '' }); setPage(1); }}
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-4">
        {loading ? (
          ...
          <div className="py-16 flex flex-col items-center text-center px-6">
            ...
            <p className="text-xs text-gray-400">Customer reviews will appear here once submitted.</p>
          </div>
        ) : (
              ...
              <div key={r._id}
                ...
                <div className="flex items-center gap-1.5 shrink-0 mt-0.5">
                  <button
                    disabled
                    title="AI reply suggestions coming soon"
                    className="hidden md:flex items-center gap-1 px-2.5 py-1.5 text-[10px] font-semibold rounded-lg border border-gray-200 text-gray-400 cursor-not-allowed">
                    {'\u2736'} AI Reply
                  </button>
                  <button
